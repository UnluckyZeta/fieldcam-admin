-- Add review status columns to public.photo_logs
ALTER TABLE public.photo_logs
ADD COLUMN IF NOT EXISTS review_status text CHECK (review_status IN ('verified', 'flagged')),
...
-- Recreate view public.photo_logs_with_engineer
