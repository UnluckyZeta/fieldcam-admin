import { $ as AstroError, A as MissingImageDimension, C as InvalidImageService, N as NoImageMetadata, V as RemoteImageNotAllowed, X as UnsupportedImageConversion, Z as UnsupportedImageFormat, c as ExpectedImage, d as FailedToFetchRemoteImageDimensions, l as ExpectedImageOptions, u as ExpectedNotESMImage, w as LocalImageUsedWrongly, y as IncompatibleDescriptorOptions } from "./shorthash_aHtTz3Kx.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./image-service_Cajv5nWZ.mjs").catch((e) => {
...
//#endregion
export { fetchWithRedirects as a, verifyOptions as i, getImage as n, isESMImportedImage as o, baseService as r, resolveSrc as s, getConfiguredImageService as t };
